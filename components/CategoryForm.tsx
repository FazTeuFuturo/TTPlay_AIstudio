...
const CategoryForm: React.FC<CategoryFormProps> = ({ eventId, onFormClose }) => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-8">
        <h2 className="text-3xl font-extrabold text-white mb-6">Adicionar Nova Categoria</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="number" id="entryFee" value={entryFee} onChange={e => setEntryFee(e.target.value)} className="w-full bg-slate-900 border border-slate-600 rounded px-3 py-2 text-white" />
            </div>
            <div>
