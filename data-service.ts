...
export const initializeDatabase = async () => {
  // A lógica de seeding para usuários de teste foi removida a pedido do usuário.
  // Isso resolve problemas de persistência de login e permite uma nova estratégia de testes.
  return;
};
